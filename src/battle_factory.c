...
{
    MOVE_SWORDS_DANCE, MOVE_GROWTH, MOVE_MEDITATE, MOVE_AGILITY, MOVE_DOUBLE_TEAM, MOVE_HARDEN, MOVE_NASTY_PLOT,
    MOVE_MINIMIZE, MOVE_WITHDRAW, MOVE_DEFENSE_CURL, MOVE_BARRIER, MOVE_FOCUS_ENERGY, MOVE_AMNESIA, MOVE_QUIVER_DANCE,
    MOVE_ACID_ARMOR, MOVE_SHARPEN, MOVE_CONVERSION, MOVE_CONVERSION_2, MOVE_BELLY_DRUM, MOVE_PSYCH_UP, MOVE_ROCK_POLISH,
    MOVE_CHARGE, MOVE_SNATCH, MOVE_TAIL_GLOW, MOVE_COSMIC_POWER, MOVE_IRON_DEFENSE, MOVE_HOWL, MOVE_BULK_UP, MOVE_CALM_MIND, MOVE_DRAGON_DANCE, MOVE_COTTON_GUARD, MOVE_COIL, MOVE_AUTOTOMIZE,
    MOVE_NONE
};
...
static const u16 sMoves_ImpossibleToPredict[] =
{
    ...
    MOVE_PRESENT, MOVE_FOLLOW_ME, MOVE_TRICK, MOVE_ROLE_PLAY, MOVE_ASSIST, MOVE_SKILL_SWAP, MOVE_CAMOUFLAGE, MOVE_TRICK_ROOM, MOVE_TRICK, MOVE_POWER_TRICK,
    MOVE_NONE
};
...
static const u16 sMoves_WeakeningTheFoe[] =
{
    ...
    MOVE_FAKE_TEARS, MOVE_METAL_SOUND, MOVE_TICKLE, MOVE_STRENGTH_SAP, MOVE_DRAIN_PUNCH, MOVE_HORN_LEECH, MOVE_INFESTATION,
    MOVE_NONE
};

static const u16 sMoves_HighRiskHighReturn[] =
{
    MOVE_GUILLOTINE, MOVE_HORN_DRILL, MOVE_DOUBLE_EDGE, MOVE_HYPER_BEAM, MOVE_COUNTER, MOVE_FISSURE, MOVE_METAL_BURST, MOVE_HEAD_SMASH, MOVE_BELLY_DRUM,
    MOVE_BIDE, MOVE_SELF_DESTRUCT, MOVE_SKY_ATTACK, MOVE_EXPLOSION, MOVE_FLAIL, MOVE_REVERSAL, MOVE_DESTINY_BOND, MOVE_THRASH, MOVE_OUTRAGE, MOVE_STONE_EDGE, MOVE_STORED_POWER, MOVE_BRAVE_BIRD, MOVE_GIGA_IMPACT,
    MOVE_PERISH_SONG, MOVE_PAIN_SPLIT, MOVE_MIRROR_COAT, MOVE_MEMENTO, MOVE_GRUDGE, MOVE_FACADE, MOVE_FOCUS_PUNCH, MOVE_WILD_CHARGE, MOVE_CLOSE_COMBAT, MOVE_HI_JUMP_KICK, MOVE_JUMP_KICK,
    MOVE_BLAST_BURN, MOVE_HYDRO_CANNON, MOVE_OVERHEAT, MOVE_FRENZY_PLANT, MOVE_PSYCHO_BOOST, MOVE_VOLT_TACKLE, MOVE_FOCUS_BLAST, MOVE_FELL_STINGER, MOVE_SHELL_SMASH, MOVE_SUPERPOWER, MOVE_FLARE_BLITZ, MOVE_FUTURE_SIGHT,
    MOVE_NONE
};

static const u16 sMoves_Endurance[] =
{
    MOVE_MIST, MOVE_RECOVER, MOVE_LIGHT_SCREEN, MOVE_HAZE, MOVE_REFLECT, MOVE_SOFT_BOILED, MOVE_REST, MOVE_PROTECT, MOVE_WIDE_GUARD,
    ...
    MOVE_MUD_SPORT, MOVE_SLACK_OFF, MOVE_AROMATHERAPY, MOVE_WATER_SPORT, MOVE_ROOST, MOVE_TAILWIND, MOVE_HEALING_WISH, MOVE_STOCKPILE, MOVE_SWALLOW, 
    MOVE_NONE
};
...
static const u16 sMoves_SlowAndSteady[] =
{
    ...
    MOVE_SPIDER_WEB, MOVE_SWEET_KISS, MOVE_SPIKES, MOVE_TOXIC_SPIKES, MOVE_STICKY_WEB, MOVE_STEALTH_ROCK, MOVE_SWAGGER, MOVE_MEAN_LOOK, MOVE_ATTRACT, MOVE_ENCORE, MOVE_TORMENT,
    MOVE_FLATTER, MOVE_WILL_O_WISP, MOVE_TAUNT, MOVE_YAWN, MOVE_IMPRISON, MOVE_SNATCH, MOVE_TEETER_DANCE, MOVE_GRASS_WHISTLE, MOVE_BLOCK, MOVE_DEFOG, MOVE_RAPID_SPIN, MOVE_INGRAIN, MOVE_NUZZLE,
    MOVE_NONE
};
