const u8 gMoveNames[MOVES_COUNT][MOVE_NAME_LENGTH + 1] =
{
    ...
    [MOVE_KINGS_SHIELD] = _("Kng's Shield"),
    ...
    [MOVE_DAZZLING_GLEAM] = _("Dzzlng Gleam"),
    ...
    [MOVE_PRECIPICE_BLADES] = _("Prcpce Blade"),
    [MOVE_DRAGON_ASCENT] = _("DragonAscent"),
    [MOVE_HYPERSPACE_FURY] = _("Hyprspc Fury"),
    [MOVE_SHORE_UP] = _("Shore Up"),
    [MOVE_FIRST_IMPRESSION] = _("FrstImpressn"),
    [MOVE_BANEFUL_BUNKER] = _("BanefulBunkr"),
    [MOVE_SPIRIT_SHACKLE] = _("SpiritShckle"),
    [MOVE_DARKEST_LARIAT] = _("DarkstLariat"),
    [MOVE_SPARKLING_ARIA] = _("Sprklng Aria"),
    [MOVE_ICE_HAMMER] = _("Ice Hammer"),
    [MOVE_FLORAL_HEALING] = _("FlorlHealing"),
    [MOVE_HIGH_HORSEPOWER] = _("HghHrsepwr"),
    ...
    [MOVE_NATURES_MADNESS] = _("Natre'sMdnss"),
    ...
    [MOVE_RISING_VOLTAGE] = _("RisingVltage"),
