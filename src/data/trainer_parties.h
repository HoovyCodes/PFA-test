static const struct TrainerMonItemCustomMoves sParty_Sawyer1[] = {
    ...
    .moves = {MOVE_LEAF_STORM, MOVE_EARTHQUAKE, MOVE_SLUDGE_BOMB, MOVE_SLEEP_POWDER}
    },
    {
    .iv = 255,
    .lvl = 100,
    ...
    .moves = {MOVE_FIRE_PUNCH, MOVE_FOCUS_BLAST, MOVE_AIR_SLASH, MOVE_DRAGON_PULSE}
    },
	{
    .iv = 255,
    .lvl = 100,
...
static const struct TrainerMonItemCustomMoves sParty_GruntAquaHideout2[] = {
    ...
    .moves = {MOVE_DRAGON_CLAW, MOVE_EARTHQUAKE, MOVE_STONE_EDGE, MOVE_CRUNCH}
    },
    {
    .iv = 255,
    .lvl = 100,
    ...
    .moves = {MOVE_SURF, MOVE_ICE_BEAM, MOVE_FLASH_CANNON, MOVE_DRAGON_PULSE}
    },
	{
    .iv = 255,
    .lvl = 100,
    ...
    .heldItem = ITEM_LIFE_ORB,
    .moves = {MOVE_DRACO_METEOR, MOVE_FLAMETHROWER, MOVE_BOOMBURST, MOVE_FOCUS_BLAST}
    },
	{
    .iv = 255,
    .lvl = 100,
    ...
    .moves = {MOVE_DRACO_METEOR, MOVE_EARTH_POWER, MOVE_U_TURN, MOVE_SOLAR_BEAM}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_GruntAquaHideout3[] = {
    ...
    .moves = {MOVE_ZEN_HEADBUTT, MOVE_HAMMER_ARM, MOVE_EARTHQUAKE, MOVE_BULLET_PUNCH}
    },
    {
    .iv = 255,
    .lvl = 100,
    ...
    .moves = {MOVE_HEAD_SMASH, MOVE_EARTHQUAKE, MOVE_AVALANCHE, MOVE_METAL_BURST}
    },
    {
    .iv = 255,
    .lvl = 100,
    ...
    .heldItem = ITEM_FOCUS_SASH,
    .moves = {MOVE_EARTHQUAKE, MOVE_X_SCISSOR, MOVE_ROCK_SLIDE, MOVE_SANDSTORM}
    },
	{
    .iv = 255,
    .lvl = 100,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_HEAD_SMASH, MOVE_ACROBATICS, MOVE_QUICK_ATTACK, MOVE_EARTHQUAKE}
    },
	{
    .iv = 255,
    .lvl = 100,
...
static const struct TrainerMonItemCustomMoves sParty_GruntAquaHideout4[] = {
    ...
    .moves = {MOVE_MUDDY_WATER, MOVE_ICE_BEAM, MOVE_EARTH_POWER, MOVE_FOCUS_BLAST}
    },
	{
    .iv = 255,
    .lvl = 100,
...
static const struct TrainerMonItemCustomMoves sParty_GruntSeafloorCavern1[] = {
    ...
    .heldItem = ITEM_ROCKY_HELMET,
    .moves = {MOVE_SUCKER_PUNCH, MOVE_PROTECT, MOVE_WILL_O_WISP, MOVE_PAIN_SPLIT}
    },
    {
    .iv = 255,
    .lvl = 100,
    ...
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_AIR_SLASH, MOVE_AURA_SPHERE, MOVE_SHADOW_BALL, MOVE_GRASS_KNOT}
    },
	{
    .iv = 255,
    .lvl = 100,
...
static const struct TrainerMonItemCustomMoves sParty_GruntSeafloorCavern2[] = {
    ...
    .moves = {MOVE_HEAT_WAVE, MOVE_BUG_BUZZ, MOVE_PSYCHIC, MOVE_QUIVER_DANCE}
    },
    {
    .iv = 255,
    .lvl = 100,
    ...
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_PSYCHIC, MOVE_REFLECT, MOVE_TOXIC, MOVE_LIGHT_SCREEN}
    },
	{
    .iv = 255,
    .lvl = 100,
    ...
    .heldItem = ITEM_CHOICE_SCARF,
    .moves = {MOVE_FLAMETHROWER, MOVE_PSYCHIC, MOVE_SHADOW_BALL, MOVE_ENERGY_BALL}
    },
	{
    .iv = 255,
    .lvl = 100,
...
static const struct TrainerMonItemCustomMoves sParty_GruntSeafloorCavern3[] = {
    ...
    .heldItem = ITEM_LIFE_ORB,
    .moves = {MOVE_SWORDS_DANCE, MOVE_FLYING_PRESS, MOVE_X_SCISSOR, MOVE_POISON_JAB}
    },
    {
    .iv = 255,
    .lvl = 100,
    ...
    .heldItem = ITEM_CHOICE_BAND,
    .moves = {MOVE_EARTHQUAKE, MOVE_DRAGON_CLAW, MOVE_HEAD_SMASH, MOVE_CRUNCH}
    },
    {
    .iv = 255,
    .lvl = 100,
    ...
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_THUNDER, MOVE_REFLECT, MOVE_BLIZZARD, MOVE_LIGHT_SCREEN}
    },
	{
    .iv = 255,
    .lvl = 100,
    ...
    .moves = {MOVE_DRAGON_PULSE, MOVE_FIRE_BLAST, MOVE_FOCUS_BLAST, MOVE_MUDDY_WATER}
    },
	{
    .iv = 255,
    .lvl = 100,
    ...
    .moves = {MOVE_TRICK_OR_TREAT, MOVE_SEED_BOMB, MOVE_SHADOW_SNEAK, MOVE_PHANTOM_FORCE}
    },
	{
    .iv = 255,
    .lvl = 100,
...
static const struct TrainerMonItemCustomMoves sParty_Gabrielle1[] = {
    ...
    .heldItem = ITEM_LIFE_ORB,
    .moves = {MOVE_THUNDERBOLT, MOVE_PSYCHIC, MOVE_FOCUS_BLAST, MOVE_QUICK_ATTACK}
    },
    {
    .iv = 255,
    .lvl = 100,
    ...
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_HYDRO_PUMP, MOVE_QUICK_ATTACK, MOVE_CHARM, MOVE_BABY_DOLL_EYES}
    },
    {
    .iv = 255,
    .lvl = 100,
    ...
    .heldItem = ITEM_CHOICE_BAND,
    .moves = {MOVE_ZEN_HEADBUTT, MOVE_DOUBLE_EDGE, MOVE_ZEN_HEADBUTT, MOVE_IRON_HEAD}
    },
	{
    .iv = 255,
    .lvl = 100,
    ...
    .moves = {MOVE_DRAGON_PULSE, MOVE_AIR_SLASH, MOVE_SUPER_FANG, MOVE_DARK_PULSE}
    },
	{
    .iv = 255,
    .lvl = 100,
    ...
    .moves = {MOVE_POWER_UP_PUNCH, MOVE_DIZZY_PUNCH, MOVE_ICE_HAMMER, MOVE_STONE_EDGE}
    },
	{
    .iv = 255,
    .lvl = 100,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SPIRIT_SHACKLE, MOVE_SMACK_DOWN, MOVE_LEAF_BLADE, MOVE_NONE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_GruntPetalburgWoods[] = {
    ...
    .heldItem = ITEM_LIFE_ORB,
    .moves = {MOVE_STONE_EDGE, MOVE_ACCELEROCK, MOVE_CRUNCH, MOVE_STEALTH_ROCK}
    },
    {
    .iv = 255,
    .lvl = 100,
    ...
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_DAZZLING_GLEAM, MOVE_BLIZZARD, MOVE_ICE_SHARD, MOVE_SAFEGUARD}
    },
    {
    .iv = 255,
    .lvl = 100,
    ...
    .species = SPECIES_TAUROS,
    .heldItem = ITEM_RAZOR_FANG,
    .moves = {MOVE_CRUSH_CLAW, MOVE_BRAVE_BIRD, MOVE_TAILWIND, MOVE_WHIRLWIND}
    },
	{
    .iv = 255,
    .lvl = 100,
    ...
    .moves = {MOVE_THUNDERBOLT, MOVE_THUNDER_WAVE, MOVE_FLASH_CANNON, MOVE_MIRROR_COAT}
    },
	{
    .iv = 255,
    .lvl = 100,
    ...
    .species = SPECIES_SNORLAX,
    .heldItem = ITEM_ASSAULT_VEST,
    .moves = {MOVE_CRUNCH, MOVE_HEAVY_SLAM, MOVE_HIGH_HORSEPOWER, MOVE_BODY_SLAM}
    },
	{
    .iv = 255,
    .lvl = 100,
    ...
    .moves = {MOVE_SPARKLING_ARIA, MOVE_MOONBLAST, MOVE_AQUA_JET, MOVE_HYPER_VOICE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Marcel[] = {
    ...
    .heldItem = ITEM_ROCKY_HELMET,
    .moves = {MOVE_STEALTH_ROCK, MOVE_TOXIC, MOVE_ROOST, MOVE_WHIRLWIND}
    },
    {
    .iv = 255,
    .lvl = 100,
    ...
    .heldItem = ITEM_LIFE_ORB,
    .moves = {MOVE_AGILITY, MOVE_TRI_ATTACK, MOVE_THUNDERBOLT, MOVE_ICE_BEAM}
    },
	{
    .iv = 255,
    .lvl = 100,
    ...
    .moves = {MOVE_SURF, MOVE_HYDRO_PUMP, MOVE_DRAGON_PULSE, MOVE_ICE_BEAM}
    },
	{
    .iv = 255,
    .lvl = 100,
    ...
    .moves = {MOVE_SWORDS_DANCE, MOVE_FLARE_BLITZ, MOVE_STONE_EDGE, MOVE_LOW_KICK}
    },
};
...
static const struct TrainerMonItemCustomMoves sParty_Alberto[] = {
    ...
    .moves = {MOVE_DRAGON_PULSE, MOVE_FOCUS_BLAST, MOVE_DRAGON_PULSE, MOVE_SURF}
    },
    {
    .iv = 255,
    .lvl = 100,
    ...
    .moves = {MOVE_ACROBATICS, MOVE_DRAGON_CLAW, MOVE_ENDEAVOR, MOVE_STONE_EDGE}
    },
	{
    .iv = 255,
    .lvl = 100,
    ...
    .species = SPECIES_HAXORUS,
    .heldItem = ITEM_FOCUS_SASH,
    .moves = {MOVE_DRAGON_DANCE, MOVE_GUILLOTINE, MOVE_OUTRAGE, MOVE_EARTHQUAKE}
    },
};
