...
.L3623:
	...
	cmp	r4, #0x5
	bhi	.L3626	@cond_branch
	mov	r4, #0x6
.L3626:
	add	r0, r7, #0
	bl	GetBattlerAbility
	cmp	r0, #0x6d
	bne	.L3627	@cond_branch
	mov	r4, #0x6
.L3627:
	ldr	r1, .L3706+0x4
	lsl	r2, r4, #0x1
...
.LCB31766:
	cmp	r0, #0x42
	bhi	.L3662	@cond_branch
	cmp	r0, #0x3a
	bhi	.L3663	@cond_branch
	cmp	r0, #0x39
	bcc	.LCB31772
	b	.L3649	@long jump
.LCB31772:
	...
	cmp	r0, #0x25
	bhi	.L3664	@cond_branch
	cmp	r0, #0x12
	beq	.L3638	@cond_branch
	b	.L3628
.L3707:
	.align	2, 0
.L3706:
...
.L3750:
	...
	mov	r8, r1
	cmp	r0, #0xec
	beq	.L3752	@cond_branch
	mov	r0, sl
	bl	GetBattleMoveSplit
	lsl	r0, r0, #0x18
	cmp	r0, #0
	bne	.L3751	@cond_branch
.L3752:
	mov	r9, r6
	ldr	r1, .L3797
	mov	r0, #0x5c
