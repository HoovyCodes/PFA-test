...
__attribute__((section("ewram_data"))) static u16 sHatchedEggLevelUpMoves[(255 > 50 ? 255 : 50)] = {0};
...
# 4011 "src/data/pokemon/egg_moves.h"
 ...
 (809 + 51 + 20000), 68, 515, 154, 382, 279, 179, 289, 254, 256, 415, 253
# 4048 "src/data/pokemon/egg_moves.h"
              ,

 (809 + 54 + 20000), 133, 498, 68, 306, 174, 203, 175, 468, 556, 333, 232, 400
# 4062 "src/data/pokemon/egg_moves.h"
                   ,

 (809 + 56 + 20000), 97, 204, 50, 227, 326, 175, 573, 336, 95, 585, 384, 180, 290, 541
# 4078 "src/data/pokemon/egg_moves.h"
                 ,

 (809 + 58 + 20000), 246, 251, 203, 185, 515, 29, 262, 319, 228, 179, 37
# 4091 "src/data/pokemon/egg_moves.h"
              ,

 (809 + 60 + 20000), 133, 274, 204, 343, 175, 260, 492, 95, 575, 386, 289, 180
# 4105 "src/data/pokemon/egg_moves.h"
             ,

 (809 + 62 + 20000), 475, 335, 68, 174, 203, 175, 393, 431, 103, 469
# 4117 "src/data/pokemon/egg_moves.h"
                  ,

 (809 + 65 + 20000), 372, 499, 174, 286, 212, 612, 228, 184, 425, 180, 255, 254, 256
# 4132 "src/data/pokemon/egg_moves.h"
               ,
