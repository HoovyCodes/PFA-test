...
#define B_CRASH_IF_TARGET_IMMUNE    GEN_7 // In Gen4+, The user of Jump Kick or Hi Jump Kick will "keep going and crash" if it attacks a target that is immune to the move.

// Ability settings
#define B_ABILITY_WEATHER           GEN_7 // In Gen6+, ability-induced weather lasts 5 turns. Before, it lasted until the battle ended or until it was changed by a move.
...
#define B_MOODY_ACC_EVASION         GEN_7 // In Gen8+, Moody CANNOT raise Accuray and Evasion any more.
